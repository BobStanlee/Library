...
class Book {
  constructor(title, author, page, status, reading) {
    // the constructor...
      this.title = title,
      this.author = author,
      this.page = page,
...
function createLibraryCard(book, index, libraryContainer) {
  ...
  titleAuthorPageContainer.classList.add("flex", "flex-col", "gap-4");

  // Span element for the book title
  let titleSpan = document.createElement("span");
  titleSpan.classList.add("font-medium", "text-xl", "capitalize");
  ...
  authorP.classList.add("font-light", "text-gray-600", "text-base", "ml-1");
